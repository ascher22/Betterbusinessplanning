        ...
        <div className="flex flex-col min-h-screen">
          ...
          <main className="flex-grow flex flex-col items-center px-4 py-12">
            <div className="w-full max-w-[600px] text-center">
              ...
              <h2 className="text-2xl font-light text-gray-700 mb-8">Sign in</h2>

              <form onSubmit={handleSignIn} className="text-left flex flex-col items-center space-y-6">
                <div className="w-full max-w-[400px]">
                  ...
                  <p className="text-xs mt-2 text-gray-600">
                    Forgot your Username? <a href="#" className="bbp-blue-text hover:underline">Let us help</a>
                  </p>
                </div>
                ...
                <div className="w-full max-w-[400px]">
                  ...
                  />
                  <p className="text-xs mt-2 text-gray-600">
                    Forgot your Password? <a href="#" className="bbp-blue-text hover:underline">Let us help</a>
                  </p>
                </div>
                ...
                <div className="w-full max-w-[400px] pt-4 border-b border-gray-200 pb-8">
                  ...
                  <p className="text-sm text-red-600 min-h-[1.25rem] mt-3" aria-live="polite">
                    {loginError ?? ""}
                  </p>
                </div>
          ...
          <footer className="footer-bg py-10 px-4 text-center">
            <div className="max-w-[1000px] mx-auto space-y-4">
              ...
              <div className="text-[11px] leading-relaxed space-y-1">
                ...
                <p>BBPAdmin | P.O. Box 736230 | Chicago, Illinois 60673-6230 | Phone: (630) 773-2337 | Fax: (630) 775-8568</p>
                <p>Support question email <a href="mailto:support@bbpadmin.com" className="bbp-blue-text">support@bbpadmin.com</a></p>
                <p>Claims email <a href="mailto:claims@bbpadmin.com" className="bbp-blue-text">claims@bbpadmin.com</a></p>
                <p>All Rights Reserved.</p>
              </div>

              <div className="pt-4">
                <a href="#" className="text-[11px] font-bold uppercase tracking-widest bbp-blue-text hover:underline">Site Map</a>
              </div>
            </div>
          </footer>
        </div>
